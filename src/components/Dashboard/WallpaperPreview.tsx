...
const WallpaperPreview = (props: IWallpaperPreview) => {
  ...
  const deleteWallpaper = async () => {
    try {
      await axios.post(
        "/api/v1/wallpaper/deleteWallpaper",
  ...
  const modalContent =
    {
      extension: (
        <div className="w-72 rounded-xl mr-6">
          <BrowserMockup
            bentoLink={props.bentoLink}
            backgroundImageLink={props.backgroundImageLink}
  ...
  return (
    <div className="relative">
      ...
      <div className="absolute top-0 right-6 m-1 z-30 flex">
        <MiniButton
          text="Get Preview Link"
          variant="default"
          className="mx-1"
          onClickFunction={() => {
            router.push(`/preview/${githubUsername}/${wallpaperId}`);
          }}
        >
        ...
        <AlertDialog>
          ...
          <AlertDialogContent>
            ...
            <AlertDialogFooter>
              ...
              <AlertDialogAction onClick={() => deleteWallpaper()}>
                Continue
              </AlertDialogAction>
            </AlertDialogFooter>
          </AlertDialogContent>
